...
app.use(express.static('public')); // express will serve this directory holding our stylesheet etc
app.use(bodyParser.urlencoded({ extended: false }));
app.use(bodyParser.json());
app.use(basicAuth({
    authorizer: new AuthChallenger(JSON.parse(fs.readFileSync(path.join(__dirname, config.users)))), // file path returned from config file
    challenge: true,
...
// get our notes for the specified user
